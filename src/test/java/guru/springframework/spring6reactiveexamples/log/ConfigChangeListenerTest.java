package guru.springframework.spring6reactiveexamples.log;
...
class ConfigChangeListenerTest {
	...
	private static final String LOGGER_NAME = "guru.springframework.spring6reactiveexamples.log.ConfigChangeListener";

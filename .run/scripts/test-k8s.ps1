...
kubectl delete pod -n spring-6-reactive-examples --field-selector=status.phase==Succeeded
kubectl delete pod -n spring-6-reactive-examples --field-selector=status.phase==Failed
